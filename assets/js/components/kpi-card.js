/**
 * ═══════════════════════════════════════════════════════════════════════════
 * KPI CARD WIDGET - Dashboard KPI Display
 *
 * Usage:
 *   <kpi-card-widget
 *     title="Doanh Thu"
...
class KpiCardWidget extends HTMLElement {
  ...
  render() {
    ...
    const trend = this.getAttribute('trend') || 'neutral'; // positive, negative, neutral
    ...
    const sparkline = sparklineData ? this.generateSparkline(sparklineData, scheme.primary) : '';
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        /* Pulse animation for positive trend */
  ...
  generateSparkline(dataStr, color) {
