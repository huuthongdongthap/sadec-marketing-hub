 ...
 * Features: Bell icon with badge, notification panel, unread markers, mark as read
...
(function() {
  ...
  const NotificationBell = {
    STORAGE_KEY: 'sadec-notifications',
    panel: null,
    bell: null,
    badge: null,
    ...
    defaultNotifications: [
      ...
      },
      {
        ...
        message: 'Chiến dịch "Black Friday" đã dùng 80% ngân sách.',
        icon: 'warning',
      ...
      },
      {
        ...
        message: 'Hóa đơn #INV-2026-001 đã được thanh toán.',
        icon: 'check_circle',
    ...
    bindEvents() {
      ...
      // Mark all as read
      const markReadBtn = this.panel.querySelector('.btn-mark-read');
      markReadBtn.addEventListener('click', () => this.markAllAsRead());

      // Close panel button
      const closeBtn = this.panel.querySelector('.btn-close-panel');
      closeBtn.addEventListener('click', () => this.closePanel());

      // Overlay click
      const overlay = this.panel.querySelector('.notification-panel-overlay');
    ...
    renderNotifications() {
      ...
      const empty = this.panel.querySelector('.notification-empty');
    ...
    renderNotification(notif) {
      const timeAgo = this.timeAgo(notif.time);
