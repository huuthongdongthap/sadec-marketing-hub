...
# Ví dụ cho Member:
python3 scripts/activate_uitra.py huuthong.dongthap@gmail.com

# Ví dụ cho Family Ultra:
python3 scripts/activate_uitra.py matrix.duclm@gmail.com
```
...
| Gói License     | API Config | Quota/Tháng      | Email mẫu                        |
| --------------- | ---------- | ---------------- | -------------------------------- |
| Free            | Mặc định   | 100 calls        | -                                |
| Starter         | Basic      | 1,000 calls      | -                                |
| PRO (UItra)     | Advanced   | 10,000 calls     | huuthong.dongthap@gmail.com      |
| Family Ultra    | Advanced   | 10,000 calls     | matrix.duclm@gmail.com           |
